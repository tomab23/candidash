...
export const UpdateInfoList: UpdateInfo[] = [
  ...
  },
  {
    ...
    date: "2026-07-10",
    version: "v0.7.2",
    fr: "Ajout d'une zone à risque dans les paramètres pour la suppression de notes ou de votre compte",
    en: "Add a risk zone to the settings for deleting notes or your account",
    classname: "",
  },
   {
    id: 26,
  ...
  },
   {
    ...
    date: "2026-09-24",
    version: "v0.7.4",
    fr: "Changement visuel pour la suppression de votre compte",
    en: "Visual changes for deleting your account",
    classname: "",
  },
];
